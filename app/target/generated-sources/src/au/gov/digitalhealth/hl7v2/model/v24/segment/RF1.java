 ...
 * <ul>
     * <li>RF1-1: Referral Status (CE) <b> </b>
     ...
     * <li>RF1-7: Effective Date (TS) <b> </b>
...
public class RF1 extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(CE.class, true, 1, 250, new Object[]{ getMessage() }, "Referral Status");
                                  ...
                                  this.add(CE.class, false, 2, 250, new Object[]{ getMessage() }, "Referral Disposition");
                                  this.add(CE.class, false, 1, 250, new Object[]{ getMessage() }, "Referral Category");
                                  this.add(EI.class, true, 1, 158, new Object[]{ getMessage() }, "Originating Referral Identifier");
                                  this.add(TS.class, true, 1, 29, new Object[]{ getMessage() }, "Effective Date");
                                  this.add(TS.class, false, 1, 29, new Object[]{ getMessage() }, "Expiration Date");
                                  this.add(TS.class, false, 1, 27, new Object[]{ getMessage() }, "Process Date");
                                  this.add(CE.class, false, 2, 250, new Object[]{ getMessage() }, "Referral Reason");
                                  this.add(EI.class, false, -1, 158, new Object[]{ getMessage() }, "External Referral Identifier");
