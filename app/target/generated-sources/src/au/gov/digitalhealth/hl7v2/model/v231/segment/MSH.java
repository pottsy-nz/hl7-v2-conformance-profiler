 ...
 * <ul>
     ...
     * <li>MSH-15: Accept Acknowledgment Type (ID) <b> </b>
     * <li>MSH-16: Application Acknowledgment Type (ID) <b> </b>
     * <li>MSH-17: Country Code (ID) <b> </b>
     * <li>MSH-18: Character Set (ID) <b>optional repeating</b>
     * <li>MSH-19: Principal Language Of Message (CE) <b>optional repeating</b>
     * <li>MSH-20: Alternate Character Set Handling Scheme (ID) <b>optional repeating</b>
 * </ul>
 */
...
public class MSH extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(HD.class, true, 1, 180, new Object[]{ getMessage() }, "Sending Facility");
                                  this.add(HD.class, false, 1, 180, new Object[]{ getMessage() }, "Receiving Application");
                                  this.add(HD.class, true, 1, 180, new Object[]{ getMessage() }, "Receiving Facility");
                                  ...
                                  this.add(MSG.class, true, 1, 18, new Object[]{ getMessage() }, "Message Type");
                                  this.add(ST.class, true, 1, 40, new Object[]{ getMessage() }, "Message Control ID");
                                  this.add(PT.class, true, 1, 10, new Object[]{ getMessage() }, "Processing ID");
                                  ...
                                  this.add(ST.class, false, -1, 180, new Object[]{ getMessage() }, "Continuation Pointer");
                                              this.add(ID.class, true, 1, 2, new Object[]{ getMessage(), new Integer(155) }, "Accept Acknowledgment Type");
                                              this.add(ID.class, true, 1, 2, new Object[]{ getMessage(), new Integer(155) }, "Application Acknowledgment Type");
                                              this.add(ID.class, true, 1, 10, new Object[]{ getMessage(), new Integer(3166) }, "Country Code");
                                              this.add(ID.class, false, -1, 16, new Object[]{ getMessage(), new Integer(211) }, "Character Set");
    ...
    /**
     * Returns all repetitions of Principal Language Of Message (MSH-19).
     */
    ...
    /**
     * Returns a count of the current number of repetitions of Principal Language Of Message (MSH-19).
     * This method does not create a repetition, so if no repetitions have currently been defined or accessed,
     * it will return zero.
     */
    public int getPrincipalLanguageOfMessageReps() {
     ...
     * it will return zero.
     */
    public int getMsh19_PrincipalLanguageOfMessageReps() {
    	return this.getReps(19);
    }
    ...
    /**
     * Inserts a repetition of
     * MSH-19: "Principal Language Of Message" at a specific index
     *
     * @param rep The repetition index (0-indexed)
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    ...
    /**
     * Returns all repetitions of Alternate Character Set Handling Scheme (MSH-20).
     */
    ...
    /**
     * Returns a count of the current number of repetitions of Alternate Character Set Handling Scheme (MSH-20).
     * This method does not create a repetition, so if no repetitions have currently been defined or accessed,
     * it will return zero.
     */
    public int getAlternateCharacterSetHandlingSchemeReps() {
     ...
     * it will return zero.
     */
    public int getMsh20_AlternateCharacterSetHandlingSchemeReps() {
    	return this.getReps(20);
    }
    ...
    /**
     * Inserts a repetition of
     * MSH-20: "Alternate Character Set Handling Scheme" at a specific index
     *
     * @param rep The repetition index (0-indexed)
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    ...
    protected Type createNewTypeWithoutReflection(int field) {
       switch (field) {
          ...
          case 16: return new ID(getMessage(), new Integer( 3166 ));
