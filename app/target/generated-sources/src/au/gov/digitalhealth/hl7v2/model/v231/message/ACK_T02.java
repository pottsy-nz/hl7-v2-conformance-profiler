...
/**
 * <p>Represents a ACK_T02 message structure (see chapter ). This structure contains the 
 * following elements: </p>
 * <ul>
		                 * <li>1: MSH (message header segment) <b> </b> </li>
		                 * <li>2: MSA (message acknowledgment segment) <b> </b> </li>
		                 * <li>3: ERR (error segment) <b>optional repeating</b> </li>
 * </ul>
 */
//@SuppressWarnings("unused")
public class ACK_T02 extends AbstractMessage  {

    /**
     * Creates a new ACK_T02 message with DefaultModelClassFactory. 
     */ 
    public ACK_T02() { 
    ...
    /** 
     * Creates a new ACK_T02 message with custom ModelClassFactory.
     */
    public ACK_T02(ModelClassFactory factory) {
       super(factory);
       init(factory);
    }
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating ACK_T02 - this is probably a bug in the source code generator.", e);
       }
    }
     ...
     * <p>
     * Returns
     * MSA (message acknowledgment segment) - creates it if necessary
     * </p>
     * 
     *
     */
    ...
    /**
     * <p>
     * Inserts a specific repetition of ERR (error segment)
     * </p>
     * 
     *
    ...
    /**
     * <p>
     * Removes a specific repetition of ERR (error segment)
     * </p>
     * 
     *
