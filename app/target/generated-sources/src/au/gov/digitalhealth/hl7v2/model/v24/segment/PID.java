 ...
 * <ul>
     ...
     * <li>PID-10: Race (CE) <b>optional </b>
...
public class PID extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(CX.class, false, -1, 109, new Object[]{ getMessage() }, "Patient ID");
                                  this.add(CX.class, true, -1, 250, new Object[]{ getMessage() }, "Patient Identifier List");
                                  this.add(CX.class, false, -1, 150, new Object[]{ getMessage() }, "Alternate Patient ID - PID");
                                  this.add(XPN.class, true, -1, 250, new Object[]{ getMessage() }, "Patient Name");
                                  this.add(XPN.class, false, 1, 250, new Object[]{ getMessage() }, "Mother's Maiden Name");
                                  this.add(TS.class, false, 1, 31, new Object[]{ getMessage() }, "Date/Time Of Birth");
                                              this.add(IS.class, false, 1, 1, new Object[]{ getMessage(), new Integer(1) }, "Administrative Sex");
                                  this.add(XPN.class, false, -1, 250, new Object[]{ getMessage() }, "Patient Alias");
                                  this.add(CE.class, false, 1, 250, new Object[]{ getMessage() }, "Race");
                                  this.add(XAD.class, false, -1, 250, new Object[]{ getMessage() }, "Patient Address");
                                              this.add(IS.class, false, -1, 4, new Object[]{ getMessage(), new Integer(399) }, "County Code");
                                  ...
                                  this.add(CX.class, false, 2, 250, new Object[]{ getMessage() }, "Mother's Identifier");
                                  this.add(CE.class, false, 2, 250, new Object[]{ getMessage() }, "Ethnic Group");
                                  ...
                                  this.add(CE.class, false, 2, 250, new Object[]{ getMessage() }, "Citizenship");
    ...
    protected Type createNewTypeWithoutReflection(int field) {
       switch (field) {
          ...
          case 11: return new IS(getMessage(), new Integer( 399 ));
