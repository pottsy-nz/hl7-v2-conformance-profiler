...
/**
 * <p>Represents a REF_I12_OBSERVATION group structure (OBSERVATION).
 * A Group is an ordered collection of message segments that can repeat together or be optionally in/excluded together.
 * This Group contains the following elements:  
 * </p>
 * <ul>
                         * <li>1: OBR (Observation Request) <b>  </b></li>
                         * <li>2: REF_I12_RESULTS_NOTES (RESULTS_NOTES) <b> repeating </b></li>
 * </ul>
 */
...
public class REF_I12_OBSERVATION extends AbstractGroup {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(REF_I12_RESULTS_NOTES.class, true, true, false);
     ...
     * RESULTS_NOTES (RESULTS_NOTES) - creates it if necessary
     */
    ...
    /**
     * Inserts a specific repetition of RESULTS_NOTES (RESULTS_NOTES)
    ...
    /**
     * Removes a specific repetition of RESULTS_NOTES (RESULTS_NOTES)
