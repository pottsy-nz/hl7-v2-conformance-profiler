...
/**
 * <p>Represents a REF_I12_RDE_O11_ORDER_DETAIL group structure (RDE_O11_ORDER_DETAIL).
...
public class REF_I12_RDE_O11_ORDER_DETAIL extends AbstractGroup {

    /** 
     * Creates a new REF_I12_RDE_O11_ORDER_DETAIL group
     */
    public REF_I12_RDE_O11_ORDER_DETAIL(Group parent, ModelClassFactory factory) {
    ...
    private void init(ModelClassFactory factory) {
       try {
          ...
          log.error("Unexpected error creating REF_I12_RDE_O11_ORDER_DETAIL - this is probably a bug in the source code generator.", e);
       }
    }
