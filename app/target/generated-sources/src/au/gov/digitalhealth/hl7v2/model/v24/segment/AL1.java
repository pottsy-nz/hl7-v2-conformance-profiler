 ...
 * <ul>
     ...
     * <li>AL1-6: Identification Date (DT) <b>optional repeating</b>
 * </ul>
 */
...
public class AL1 extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(ST.class, false, -1, 50, new Object[]{ getMessage() }, "Allergy Reaction Code");
    ...
    /**
     * Returns all repetitions of Identification Date (AL1-6).
     */
    public DT[] getIdentificationDate() {
    	DT[] retVal = this.getTypedField(6, new DT[0]);
    	return retVal;
    }
    ...
    /**
     * Returns a count of the current number of repetitions of Identification Date (AL1-6).
     * This method does not create a repetition, so if no repetitions have currently been defined or accessed,
     * it will return zero.
     */
    public int getIdentificationDateReps() {
     ...
     * @param rep The repetition index (0-indexed)
     */
    public DT getIdentificationDate(int rep) { 
		DT retVal = this.getTypedField(6, rep);
		return retVal;
    }
     ...
     * @param rep The repetition index (0-indexed)
     */
    public DT getAl16_IdentificationDate(int rep) { 
		DT retVal = this.getTypedField(6, rep);
		return retVal;
    }
     ...
     * it will return zero.
     */
    public int getAl16_IdentificationDateReps() {
    	return this.getReps(6);
    }
    ...
    /**
     * Inserts a repetition of
     * AL1-6: "Identification Date" at a specific index
     *
     * @param rep The repetition index (0-indexed)
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public DT insertIdentificationDate(int rep) throws HL7Exception { 
        return (DT) super.insertRepetition(6, rep);
    }
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public DT insertAl16_IdentificationDate(int rep) throws HL7Exception { 
        return (DT) super.insertRepetition(6, rep);
    }
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public DT removeIdentificationDate(int rep) throws HL7Exception { 
        return (DT) super.removeRepetition(6, rep);
    }
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public DT removeAl16_IdentificationDate(int rep) throws HL7Exception { 
        return (DT) super.removeRepetition(6, rep);
    }
