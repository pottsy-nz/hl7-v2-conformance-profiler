...
public class MSH extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  ...
                                  this.add(ST.class, true, 1, 36, new Object[]{ getMessage() }, "Message Control ID");
                                  this.add(PT.class, true, 1, 7, new Object[]{ getMessage() }, "Processing ID");
                                  this.add(VID.class, true, 1, 250, new Object[]{ getMessage() }, "Version ID");
                                  ...
                                  this.add(ST.class, false, 1, 180, new Object[]{ getMessage() }, "Continuation Pointer");
                                              ...
                                              this.add(ID.class, true, 1, 3, new Object[]{ getMessage(), new Integer(3166) }, "Country Code");
                                  ...
                                  this.add(CE.class, false, 1, 250, new Object[]{ getMessage() }, "Principal Language Of Message");
                                              ...
                                              this.add(ID.class, false, -1, 10, new Object[]{ getMessage(), new Integer(0) }, "Conformance Statement ID");
