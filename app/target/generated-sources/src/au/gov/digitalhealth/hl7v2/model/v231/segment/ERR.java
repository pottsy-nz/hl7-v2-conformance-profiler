 ...
 * <ul>
     * <li>ERR-1: Error Code and Location (ELD) <b>optional </b>
 * </ul>
 */
...
public class ERR extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(ELD.class, false, 1, 141, new Object[]{ getMessage() }, "Error Code and Location");
    ...
    public ELD getErrorCodeAndLocation() { 
		ELD retVal = this.getTypedField(1, 0);
		return retVal;
    }
