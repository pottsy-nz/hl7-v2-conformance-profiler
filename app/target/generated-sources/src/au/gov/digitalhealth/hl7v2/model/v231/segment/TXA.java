 ...
 * <ul>
     ...
     * <li>TXA-3: Document Content Presentation (ID) <b> </b>
     * <li>TXA-4: Activity Date/Time (TS) <b> </b>
     * <li>TXA-5: Primary Activity Provider Code/Name (XCN) <b>optional repeating</b>
     * <li>TXA-6: Origination Date/Time (TS) <b>optional repeating</b>
     * <li>TXA-7: Transcription Date/Time (TS) <b>optional repeating</b>
     ...
     * <li>TXA-13: Parent Document Number (EI) <b>optional repeating</b>
     * <li>TXA-14: Placer Order Number (EI) <b>optional repeating</b>
     * <li>TXA-15: Filler Order Number (EI) <b>optional repeating</b>
     * <li>TXA-16: Unique Document File Name (ST) <b> </b>
     * <li>TXA-17: Document Completion Status (ID) <b> </b>
     * <li>TXA-18: Document Confidentiality Status (ID) <b>optional repeating</b>
     * <li>TXA-19: Document Availability Status (ID) <b>optional repeating</b>
     * <li>TXA-20: Document Storage Status (ID) <b>optional repeating</b>
     * <li>TXA-21: Document Change Reason (ST) <b>optional repeating</b>
...
public class TXA extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(SI.class, true, 1, 4, new Object[]{ getMessage() }, "Set ID - TXA");
                                              ...
                                              this.add(ID.class, true, 1, 10, new Object[]{ getMessage(), new Integer(191) }, "Document Content Presentation");
                                  this.add(TS.class, true, 1, 26, new Object[]{ getMessage() }, "Activity Date/Time");
                                  this.add(XCN.class, false, -1, 72, new Object[]{ getMessage() }, "Primary Activity Provider Code/Name");
                                  ...
                                  this.add(TS.class, false, -1, 26, new Object[]{ getMessage() }, "Edit Date/Time");
                                  this.add(XCN.class, false, -1, 75, new Object[]{ getMessage() }, "Originator Code/Name");
                                  this.add(XCN.class, false, -1, 75, new Object[]{ getMessage() }, "Assigned Document Authenticator");
                                  this.add(XCN.class, false, -1, 72, new Object[]{ getMessage() }, "Transcriptionist Code/Name");
                                  this.add(EI.class, true, 1, 52, new Object[]{ getMessage() }, "Unique Document Number");
                                  ...
                                  this.add(ST.class, true, 1, 22, new Object[]{ getMessage() }, "Unique Document File Name");
                                              this.add(ID.class, true, 1, 30, new Object[]{ getMessage(), new Integer(271) }, "Document Completion Status");
                                  ...
                                  this.add(PPN.class, false, -1, 103, new Object[]{ getMessage() }, "Authentication Person, Time Stamp");
                                  this.add(XCN.class, false, -1, 75, new Object[]{ getMessage() }, "Distributed Copies (Code and Name of Recipients)");
    ...
    /**
     * Returns all repetitions of Origination Date/Time (TXA-6).
     */
    ...
    /**
     * Returns a count of the current number of repetitions of Origination Date/Time (TXA-6).
     * This method does not create a repetition, so if no repetitions have currently been defined or accessed,
     * it will return zero.
     */
    public int getOriginationDateTimeReps() {
     ...
     * @param rep The repetition index (0-indexed)
     */
    public TS getOriginationDateTime(int rep) { 
     ...
     * @param rep The repetition index (0-indexed)
     */
    public TS getTxa6_OriginationDateTime(int rep) { 
		TS retVal = this.getTypedField(6, rep);
		return retVal;
    }
     ...
     * it will return zero.
     */
    public int getTxa6_OriginationDateTimeReps() {
    	return this.getReps(6);
    }
    ...
    /**
     * Inserts a repetition of
     * TXA-6: "Origination Date/Time" at a specific index
     *
     * @param rep The repetition index (0-indexed)
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public TS insertOriginationDateTime(int rep) throws HL7Exception { 
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public TS insertTxa6_OriginationDateTime(int rep) throws HL7Exception { 
        return (TS) super.insertRepetition(6, rep);
    }
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public TS removeOriginationDateTime(int rep) throws HL7Exception { 
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public TS removeTxa6_OriginationDateTime(int rep) throws HL7Exception { 
        return (TS) super.removeRepetition(6, rep);
    }
    ...
    /**
     * Returns all repetitions of Transcription Date/Time (TXA-7).
     */
    public TS[] getTranscriptionDateTime() {
    	TS[] retVal = this.getTypedField(7, new TS[0]);
    	return retVal;
    }
    ...
    /**
     * Returns a count of the current number of repetitions of Transcription Date/Time (TXA-7).
     * This method does not create a repetition, so if no repetitions have currently been defined or accessed,
     * it will return zero.
     */
    public int getTranscriptionDateTimeReps() {
     ...
     * @param rep The repetition index (0-indexed)
     */
    public TS getTranscriptionDateTime(int rep) { 
		TS retVal = this.getTypedField(7, rep);
		return retVal;
    }
     ...
     * @param rep The repetition index (0-indexed)
     */
    public TS getTxa7_TranscriptionDateTime(int rep) { 
		TS retVal = this.getTypedField(7, rep);
		return retVal;
    }
     ...
     * it will return zero.
     */
    public int getTxa7_TranscriptionDateTimeReps() {
    	return this.getReps(7);
    }
    ...
    /**
     * Inserts a repetition of
     * TXA-7: "Transcription Date/Time" at a specific index
     *
     * @param rep The repetition index (0-indexed)
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public TS insertTranscriptionDateTime(int rep) throws HL7Exception { 
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public TS insertTxa7_TranscriptionDateTime(int rep) throws HL7Exception { 
        return (TS) super.insertRepetition(7, rep);
    }
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public TS removeTranscriptionDateTime(int rep) throws HL7Exception { 
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public TS removeTxa7_TranscriptionDateTime(int rep) throws HL7Exception { 
        return (TS) super.removeRepetition(7, rep);
    }
    ...
    /**
     * Returns all repetitions of Parent Document Number (TXA-13).
     */
    ...
    /**
     * Returns a count of the current number of repetitions of Parent Document Number (TXA-13).
     * This method does not create a repetition, so if no repetitions have currently been defined or accessed,
     * it will return zero.
     */
    public int getParentDocumentNumberReps() {
     ...
     * @param rep The repetition index (0-indexed)
     */
    public EI getParentDocumentNumber(int rep) { 
     ...
     * @param rep The repetition index (0-indexed)
     */
    public EI getTxa13_ParentDocumentNumber(int rep) { 
		EI retVal = this.getTypedField(13, rep);
		return retVal;
    }
     ...
     * it will return zero.
     */
    public int getTxa13_ParentDocumentNumberReps() {
    	return this.getReps(13);
    }
    ...
    /**
     * Inserts a repetition of
     * TXA-13: "Parent Document Number" at a specific index
     *
     * @param rep The repetition index (0-indexed)
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public EI insertParentDocumentNumber(int rep) throws HL7Exception { 
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public EI insertTxa13_ParentDocumentNumber(int rep) throws HL7Exception { 
        return (EI) super.insertRepetition(13, rep);
    }
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public EI removeParentDocumentNumber(int rep) throws HL7Exception { 
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public EI removeTxa13_ParentDocumentNumber(int rep) throws HL7Exception { 
        return (EI) super.removeRepetition(13, rep);
    }
    ...
    /**
     * Returns all repetitions of Filler Order Number (TXA-15).
     */
    public EI[] getFillerOrderNumber() {
    	EI[] retVal = this.getTypedField(15, new EI[0]);
    	return retVal;
    }
    ...
    /**
     * Returns a count of the current number of repetitions of Filler Order Number (TXA-15).
     * This method does not create a repetition, so if no repetitions have currently been defined or accessed,
     * it will return zero.
     */
    ...
    public EI getFillerOrderNumber(int rep) { 
		EI retVal = this.getTypedField(15, rep);
		return retVal;
    }
     ...
     * @param rep The repetition index (0-indexed)
     */
    public EI getTxa15_FillerOrderNumber(int rep) { 
		EI retVal = this.getTypedField(15, rep);
		return retVal;
    }
     ...
     * it will return zero.
     */
    public int getTxa15_FillerOrderNumberReps() {
    	return this.getReps(15);
    }
    ...
    /**
     * Inserts a repetition of
     * TXA-15: "Filler Order Number" at a specific index
     *
     * @param rep The repetition index (0-indexed)
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public EI insertFillerOrderNumber(int rep) throws HL7Exception { 
        return (EI) super.insertRepetition(15, rep);
    }
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public EI insertTxa15_FillerOrderNumber(int rep) throws HL7Exception { 
        return (EI) super.insertRepetition(15, rep);
    }
    ...
    public EI removeFillerOrderNumber(int rep) throws HL7Exception { 
        return (EI) super.removeRepetition(15, rep);
    }
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public EI removeTxa15_FillerOrderNumber(int rep) throws HL7Exception { 
        return (EI) super.removeRepetition(15, rep);
    }
    ...
    /**
     * Returns all repetitions of Document Confidentiality Status (TXA-18).
     */
    ...
    /**
     * Returns a count of the current number of repetitions of Document Confidentiality Status (TXA-18).
     * This method does not create a repetition, so if no repetitions have currently been defined or accessed,
     * it will return zero.
     */
    public int getDocumentConfidentialityStatusReps() {
     ...
     * @param rep The repetition index (0-indexed)
     */
    public ID getDocumentConfidentialityStatus(int rep) { 
     ...
     * @param rep The repetition index (0-indexed)
     */
    public ID getTxa18_DocumentConfidentialityStatus(int rep) { 
		ID retVal = this.getTypedField(18, rep);
		return retVal;
    }
     ...
     * it will return zero.
     */
    public int getTxa18_DocumentConfidentialityStatusReps() {
    	return this.getReps(18);
    }
    ...
    /**
     * Inserts a repetition of
     * TXA-18: "Document Confidentiality Status" at a specific index
     *
     * @param rep The repetition index (0-indexed)
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public ID insertDocumentConfidentialityStatus(int rep) throws HL7Exception { 
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public ID insertTxa18_DocumentConfidentialityStatus(int rep) throws HL7Exception { 
        return (ID) super.insertRepetition(18, rep);
    }
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public ID removeDocumentConfidentialityStatus(int rep) throws HL7Exception { 
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public ID removeTxa18_DocumentConfidentialityStatus(int rep) throws HL7Exception { 
        return (ID) super.removeRepetition(18, rep);
    }
    ...
    /**
     * Returns all repetitions of Document Availability Status (TXA-19).
     */
    ...
    /**
     * Returns a count of the current number of repetitions of Document Availability Status (TXA-19).
     * This method does not create a repetition, so if no repetitions have currently been defined or accessed,
     * it will return zero.
     */
    public int getDocumentAvailabilityStatusReps() {
     ...
     * @param rep The repetition index (0-indexed)
     */
    public ID getDocumentAvailabilityStatus(int rep) { 
     ...
     * @param rep The repetition index (0-indexed)
     */
    public ID getTxa19_DocumentAvailabilityStatus(int rep) { 
		ID retVal = this.getTypedField(19, rep);
		return retVal;
    }
     ...
     * it will return zero.
     */
    public int getTxa19_DocumentAvailabilityStatusReps() {
    	return this.getReps(19);
    }
    ...
    /**
     * Inserts a repetition of
     * TXA-19: "Document Availability Status" at a specific index
     *
     * @param rep The repetition index (0-indexed)
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public ID insertDocumentAvailabilityStatus(int rep) throws HL7Exception { 
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public ID insertTxa19_DocumentAvailabilityStatus(int rep) throws HL7Exception { 
        return (ID) super.insertRepetition(19, rep);
    }
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public ID removeDocumentAvailabilityStatus(int rep) throws HL7Exception { 
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public ID removeTxa19_DocumentAvailabilityStatus(int rep) throws HL7Exception { 
        return (ID) super.removeRepetition(19, rep);
    }
    ...
    /**
     * Returns all repetitions of Document Storage Status (TXA-20).
     */
    ...
    /**
     * Returns a count of the current number of repetitions of Document Storage Status (TXA-20).
     * This method does not create a repetition, so if no repetitions have currently been defined or accessed,
     * it will return zero.
     */
    public int getDocumentStorageStatusReps() {
     ...
     * @param rep The repetition index (0-indexed)
     */
    public ID getDocumentStorageStatus(int rep) { 
     ...
     * @param rep The repetition index (0-indexed)
     */
    public ID getTxa20_DocumentStorageStatus(int rep) { 
		ID retVal = this.getTypedField(20, rep);
		return retVal;
    }
     ...
     * it will return zero.
     */
    public int getTxa20_DocumentStorageStatusReps() {
    	return this.getReps(20);
    }
    ...
    /**
     * Inserts a repetition of
     * TXA-20: "Document Storage Status" at a specific index
     *
     * @param rep The repetition index (0-indexed)
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public ID insertDocumentStorageStatus(int rep) throws HL7Exception { 
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public ID insertTxa20_DocumentStorageStatus(int rep) throws HL7Exception { 
        return (ID) super.insertRepetition(20, rep);
    }
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public ID removeDocumentStorageStatus(int rep) throws HL7Exception { 
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public ID removeTxa20_DocumentStorageStatus(int rep) throws HL7Exception { 
        return (ID) super.removeRepetition(20, rep);
    }
    ...
    /**
     * Returns all repetitions of Document Change Reason (TXA-21).
     */
    ...
    /**
     * Returns a count of the current number of repetitions of Document Change Reason (TXA-21).
     * This method does not create a repetition, so if no repetitions have currently been defined or accessed,
     * it will return zero.
     */
    public int getDocumentChangeReasonReps() {
     ...
     * @param rep The repetition index (0-indexed)
     */
    public ST getDocumentChangeReason(int rep) { 
     ...
     * @param rep The repetition index (0-indexed)
     */
    public ST getTxa21_DocumentChangeReason(int rep) { 
		ST retVal = this.getTypedField(21, rep);
		return retVal;
    }
     ...
     * it will return zero.
     */
    public int getTxa21_DocumentChangeReasonReps() {
    	return this.getReps(21);
    }
    ...
    /**
     * Inserts a repetition of
     * TXA-21: "Document Change Reason" at a specific index
     *
     * @param rep The repetition index (0-indexed)
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public ST insertDocumentChangeReason(int rep) throws HL7Exception { 
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public ST insertTxa21_DocumentChangeReason(int rep) throws HL7Exception { 
        return (ST) super.insertRepetition(21, rep);
    }
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public ST removeDocumentChangeReason(int rep) throws HL7Exception { 
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public ST removeTxa21_DocumentChangeReason(int rep) throws HL7Exception { 
        return (ST) super.removeRepetition(21, rep);
    }
