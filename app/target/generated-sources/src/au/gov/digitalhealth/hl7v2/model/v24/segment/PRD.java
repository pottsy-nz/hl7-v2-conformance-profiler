 ...
 * <ul>
     ...
     * <li>PRD-5: Provider Communication Information (XTN) <b> repeating</b>
...
public class PRD extends AbstractSegment {
    ...
    private void init(ModelClassFactory factory) {
       try {
                                  this.add(CE.class, true, -1, 250, new Object[]{ getMessage() }, "Provider Role");
                                  this.add(XPN.class, false, -1, 250, new Object[]{ getMessage() }, "Provider Name");
                                  this.add(XAD.class, false, -1, 349, new Object[]{ getMessage() }, "Provider Address");
                                  this.add(PL.class, false, 1, 109, new Object[]{ getMessage() }, "Provider Location");
                                  this.add(XTN.class, true, -1, 280, new Object[]{ getMessage() }, "Provider Communication Information");
                                  this.add(CE.class, false, 1, 250, new Object[]{ getMessage() }, "Preferred Method of Contact");
                                  this.add(PI.class, false, -1, 100, new Object[]{ getMessage() }, "Provider Identifiers");
                                  this.add(TS.class, false, 1, 31, new Object[]{ getMessage() }, "Effective Start Date of Provider Role");
                                  this.add(TS.class, false, 1, 31, new Object[]{ getMessage() }, "Effective End Date of Provider Role");
